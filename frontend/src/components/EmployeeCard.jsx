...
const EmployeeCard = () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className='p-1 md:p-3 my-4 hover:shadow-lg max-w-4xl mx-auto shadow-slate-100 border border-gray-100 duration-500'>
      ...
      <button className='sm:hidden justify-center mx-auto w-4/5 py-2.5 mt-2 mb-1 flex items-center ml-auto bg-indigo-500 hover:bg-slate-50 hover:text-indigo-500 rounded-full text-white hover:border border-indigo-500 gap-x-1 duration-500'>
        View Profile <AddIcon />
      </button>
    </div>
  );
